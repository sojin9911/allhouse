...
<div class="c_board_list news_list">
	...
	<table>
		<colgroup>
			<col width="60"/><col width="230"/><col width="*"/><col width="120"/><col width="80"/>
		</colgroup>
		<thead>
			<tr>
				<th scope="col">번호</th>
				<th scope="col" colspan="2">정보</th>
				<th scope="col">날짜</th>
				<th scope="col">조회수</th>
			</tr>
		</thead>
		...
		<?php foreach($listPost as $k=>$v) {  ?>
			...
			<tr class="<?php echo $v['trClass']; ?>">
				...
				<!-- 웹진형 썸네일 200 * free -->
				<td class="news_thumb">
					<a href="<?php echo $v['postUrl']; ?>" class="thumb_box<?php echo $v['secretEvtClass'];?>" data-uid="<?php echo $v['uid'] ?>" data-mode="view" title="<?php echo $v['title']; ?>"><?php echo $v['thumb']; ?></a>
				</td>
				<td class="tit">
					<div class="title">
