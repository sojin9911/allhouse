	...
	<div class="c_board_list">
		...
		<div class="c_list_ctrl for_change_btn">
			<form role="search" action="/" method="get">
				...
				<div class="search">
					<input type="search" name="search_word" value="<?php echo $search_word; ?>" class="input_search" placeholder="검색어 입력">
						...
						<li class="js_view" data-uid="<?php echo $v['pt_uid']; ?>" data-hit="false"><!-- 클릭하면 상세보기 열림 -->
							<div class="conts_box">
								...
								<ul>
									<li class="this_thumb">
										<div class="thumb_box">
											<a href="<?php echo $pro_link; ?>" class="thumb" title="<?php echo addslashes(htmlspecialchars($v['p_name'])); ?>" target="_blank">
									...
									<li>
										...
										<div class="title">
											...
											<a href="<?php echo $pro_link; ?>" class="sub_txt" target="_blank">상품명 : <?php echo htmlspecialchars($v['p_name']); ?></a><!-- 상품으로 이동 -->
										</div>
										<div class="info">
											<div class="t_writer"><?php echo LastCut2($v['pt_inid'], 3); ?></div>
