<div class="c_pop" id="product_cancel_pop" style="display:none;height:auto;">
		...
		<div class="wrapping">
			<div class="inner">
				<div class="box">
										...
										<div class="cart_item_box">
											<ul>
												<li class="thumb">
													...
													<a href="" class="thumb_box product_link" target="_blank"><img class="product_thumb" alt="상품명"></a>
												</li>
												<li class="item_name">
													<a href="#none" class="title product_name product_link"><!-- 상품명 --></a>
												</li>
											</ul>
							...
							<table  style="margin-top:5px;">
								<tbody>
									...
									<tr class="view_pg" style="display:none;">
										...
										<td>
											<div class="input_box">
												<input type="text" name="cancel_bank_name" class="input_design" value="<?php echo $mem_info['in_cancel_bank_name']; ?>"  placeholder="예금주" />
											</div>
											<div class="select">
											...
											<div class="input_box">
												<input type="text" name="cancel_bank_account" class="input_design" value="<?php echo $mem_info['in_cancel_bank_account']; ?>" placeholder="계좌번호" >
											</div>
									...
									<tr>
										...
										<td>
											<div class="textarea_box"><textarea name="cancel_msg" rows="" style="" class="textarea_design" placeholder="관리자에게 전달하실 내용이 있다면 입력해주세요."></textarea></div>
										</td>
									</tr>
								</tbody>
							</table>
					...
					<div class="c_btnbox">
						<ul>
							<li><span class="c_btn h40 dark"><input type="submit" value="취소신청"></span></li>
...
<div class="c_pop" id="product_cancel_view_pop" style="display:none;height:auto;">
