				...
				<dl>
					...
					<dd class='counter'>
						<div class='view_counter'>
							<a href='#none' onclick=\"".$is_addoption."option_select_update('down' , '" . $sr['pto_uid'] . "','" . $sr['pto_pcode'] . "')\" class='btn_down' title='빼기'><span class='shape'></span></a>
							<input type='text' name='' id='input_cnt_".$is_addoption.$sr[pto_uid]."' class='updown_input' value='".$sr['pto_cnt']."' readonly>
							<a href='#none' onclick=\"".$is_addoption."option_select_update('up' , '" . $sr['pto_uid'] . "','" . $sr['pto_pcode'] . "');\" class='btn_up' title='더하기'><span class='shape'></span></a>
						</div>
						<span class='price'><strong>" . number_format($sr['pto_poptionprice'] * $sr['pto_cnt'] - $groupSetPrice) . "</strong>원".$printGroupSet."</span>
						<a href='#none' onclick=\"option_select_del('" . $sr['pto_uid'] . "','".$sr['pto_pcode']."')\" class='btn_delete' title='옵션삭제'></a>
					</dd>
				</dl>
            ";
