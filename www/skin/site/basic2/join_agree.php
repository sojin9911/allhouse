<div id="container">
        ...
        <!-- 본문 시작 -->
            ...
            <div class="location_wrap">
                <div class="location_cont" style="display:none">
...
<div class="content_box">
	<div class="join_agreement_wrap">
		<div class="member_tit">
			<h2>회원가입</h2>
			<ol>
				<li class="page_on"><span>01</span> 약관동의<span><img src="/skin/site/basic2/images/icon_join_step_on.png" alt=""></span></li>
				<li><span>02</span> 정보입력<span><img src="/skin/site/basic2/images/icon_join_step_off.png" alt=""></span></li>
				<li><span>03</span> 가입완료</li>
			</ol>
		</div>
		<!-- //member_tit -->
		<div class="member_cont">
			<form id="formTerms" name="formTerms" method="post" action="/?pn=member.join.form&all_check=Y">
				<input type="hidden" name="token" value="MTY2MzI5MjE2MDc2NzI4NzIyNDE1ODA1ODIzMzQwMDg2MzIyOTcxNDIx">
				...
				<div class="join_agreement_cont">
					<div class="join_agreement_box">
						<div class="form_element">
							...
							<label class="check" for="allAgree"> <em>올하우스의 모든 약관을 확인하고 전체 동의합니다.</em></label>
					...
					<div class="join_agreement_box js_terms_view">
						<div class="form_element">
							...
							<span><a href="/?pn=pages.view&type=agree&data=agree" target="_blank">전체보기</a></span>
						</div>
...
표준약관 제10023호<br>
<br>
이 약관은 올하우스컴퍼니 회사(전자거래 사업자)가 운영하는 올하우스 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」<br>
<br>
<br>
제2조(정의)<br>
<br>
① "몰"이란 올하우스컴퍼니 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
...
1. 이 약관은 년 월 일부터 적용됩니다.<br>
					...
					<div class="join_agreement_box js_terms_view">
						<div class="form_element">
							...
							<span><a href="/?pn=pages.view&type=agree&data=privacy" target="_blank">전체보기</a></span>
						</div>
						<div class="agreement_box">
...
<script type="text/javascript">
	$(document).ready(function () {
				...
				if ($('input[name="RnCheckType"]').length > 0) {
					switch ($('input[name="RnCheckType"]:checked').val()) {
						...
						case  'authCellPhone' :
							...
							var callbackUrl = "http://comondev.com/member/authcellphone/dreamsecurity_result.php";
							window.open(protocol + "//hpauthdream.godo.co.kr/module/Mobile_hpauthDream_Main.php?callType=joinmembermobile&shopUrl=" + callbackUrl + "&cpid=", "auth_popup", "top=30, left=50, status=0, width=425, height=650");
							break;
						default :
							alert("본인인증이 필요합니다.");
		...
		$('#btnPrevStep', $formTerms).click(function (e) {
			e.preventDefault();
			window.location.href = '/?pn=join_method'
		});
