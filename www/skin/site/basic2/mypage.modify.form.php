		...
		<div class="mypage_section">
			...
			<div class="right_sec">	
				<div class="right_sec_wrap">
					...
					<!-- ◆정보입력 -->
						<div class="c_group_tit"><span class="tit">정보수정</span></div>
						<div class="c_form">
							<table>
								<colgroup>
								...
								<tbody>
									<tr<?php echo ($sns_join_type != 'direct'?' style="display:none"':null); ?>>
										...
										<td colspan="3">
											<div class="input_box">
												<input type="text" name="join_id" class="input_design" value="<?php echo $mem_info['in_id']; ?>" style="width:200px" readonly/>
											</div>
										</td>
									</tr>
									<tr<?php echo ($sns_join_type != 'direct'?' style="display:none"':null); ?>>
									...
									<tr>
																	...
																	<td<?php echo ($siteInfo['join_birth'] == 'N'?' colspan="3"':null); ?>>
																			<div class="input_box">
																					<?php if($siteInfo['s_join_auth_use'] == 'Y') { // 2018-10-04 SSJ :: 본인인증 사용 시 ?>
																							<input type="text" name="join_name" class="input_design js_auth_before auth_name" value="<?php echo $mem_info['in_name']; ?>" style="width:120px" readonly />
																					<?php } else { ?>
																							<input type="text" name="join_name" class="input_design" value="<?php echo $mem_info['in_name']; ?>" style="width:120px" readonly />
																					<?php } ?>
																			</div>
																	</td>
										<?php if($siteInfo['join_birth'] == 'Y') { ?>
																			...
																			<td>
																					<?php if($siteInfo['s_join_auth_use'] == 'Y') { // 2018-10-04 SSJ :: 본인인증 사용 시 ?>
																							<!-- 달력나옴 -->
																							<input type="text" name="_birth" class="input_design if_date js_auth_before auth_birth" value="<?php echo $mem_info['in_birth']; ?>" style="width:120px" readonly />
																					<?php } else { ?>
																							<!-- 달력나옴 -->
																							<input type="text" name="_birth" class="input_design if_date<?php echo (empty($mem_info['in_birth']) || $mem_info['in_birth'] == '0000-00-00' || $mem_info['in_birth'] == ''?' js_pic_day_max_today':null); ?>" value="<?php echo $mem_info['in_birth']; ?>" style="width:120px" readonly />
																					<?php } ?>
																			</td>
																	<?php } ?>
									</tr>
									<?php if($siteInfo['join_sex'] == 'Y' || $siteInfo['join_tel'] == 'Y') { ?>
										<tr>
											...
											<?php if($siteInfo['join_tel'] == 'Y') { ?>
												...
												<td<?php echo ($siteInfo['join_sex'] == 'N' && $siteInfo['join_tel'] == 'Y'?' colspan="3"':null); ?>>
													<input type="text" name="join_tel" class="input_design" value="<?php echo $mem_info['in_tel']; ?>" style="width:180px" />
									...
									<tr>
										<th class="ess"><span class="tit">휴대폰 번호</span></th>
																	<td>
																			<div class="input_box">
																					<?php if($siteInfo['s_join_auth_use'] == 'Y') { // 2018-10-04 SSJ :: 본인인증 사용 시 ?>
																							<input type="text" name="join_tel2" class="input_design js_auth_before auth_phone" value="<?php echo $mem_info['in_tel2']; ?>" style="width:180px" readonly/>
																							<input type="button" onclick="auth_type_check();" class="c_btn h30 light" value="휴대폰 본인인증">
																					<?php } else { ?>
																							<input type="text" name="join_tel2" class="input_design" value="<?php echo $mem_info['in_tel2']; ?>" style="width:180px" />
																					<?php } ?>
																			</div>
																			<div class="tip_txt black">주문 등과 관련된 중요한 문자가 발송됩니다.</div>
																	</td>
										<th class="ess"><span class="tit">SMS 수신</span></th>
										<td>
									...
									<tr>
										<th class="ess"><span class="tit">이메일 수신</span></th>
										<td colspan="3">
									...
									<?php if($siteInfo['join_addr'] == 'Y') { ?>
										<tr>
											...
											<td>
												<div class="input_box">
													<input type="text" name="join_zonecode" id="_zonecode" class="input_design" value="<?php echo $mem_info['in_zonecode']; ?>" style="width:70px" readonly="readonly"/>
											...
											<td>
												<div class="input_box" style="display:none;">
													<input type="text" name="join_zip1" id="_post1" class="input_design" value="<?php echo $mem_info['in_zip1']; ?>" style="width:50px" readonly="readonly"/>
													<span class="dash">-</span>
													<input type="text" name="join_zip2" id="_post2" class="input_design" value="<?php echo $mem_info['in_zip2']; ?>" style="width:50px" readonly="readonly"/>
									...
									<?php if($is_sns_login_form === true) { ?>
										<tr>
											<th><span class="tit">SNS계정 연동</span></th>
											<td colspan="3">
																...
																<?php if($sns_callback_url) { ?>
																	<li>
																		<a href="#none" onclick="window.open('<?php echo $sns_callback_url; ?>', 'sns_login', 'width=800, height=500'); return false;" class="btn naver">
																			<span class="sns"><span class="kr">네이버 아이디<br/>연동하기</span></span>
																		</a>
																	</li>
																<?php } else { ?>
																	<li class="hit">
																		<a href="#none" onclick="alert('이미 연동이 완료되었습니다.'); return false;" class="btn naver">
																			<span class="sns"><span class="kr">네이버 아이디<br/>연동완료</span></span>
																		</a>
																	</li>
																<?php } ?>
															<?php } ?>
																...
																<?php if($sns_callback_url) { ?>
																	<li>
																		<a href="#none" onclick="window.open('<?php echo $sns_callback_url; ?>', 'sns_login', 'width=800, height=500'); return false;" class="btn kakao">
																			<span class="sns"><span class="kr">카카오톡 아이디<br/>연동하기</span></span>
																		</a>
																	</li>
																<?php } else { ?>
																	<li class="hit">
																		<a href="#none" onclick="alert('이미 연동이 완료되었습니다.'); return false;" class="btn kakao">
																			<span class="sns"><span class="kr">카카오톡 아이디<br/>연동완료</span></span>
																		</a>
																	</li>
																<?php } ?>
															<?php } ?>
																...
																<?php if($sns_callback_url) { ?>
																	<li>
																		<a href="#none" onclick="window.open('<?php echo $sns_callback_url; ?>', 'sns_login', 'width=800, height=500'); return false;" class="btn face">
																			<span class="sns"><span class="kr">페이스북 아이디<br/>연동하기</span></span>
																		</a>
																	</li>
																<?php } else { ?>
																	<li class="hit">
																		<a href="#none" onclick="alert('이미 연동이 완료되었습니다.'); return false;" class="btn face">
																			<span class="sns"><span class="kr">페이스북 아이디<br/>연동완료</span></span>
																		</a>
																	</li>
																<?php } ?>
															<?php } ?>
