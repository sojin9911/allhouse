	...
	<div class="layout_fix">
		...
		<div class="mypage_section">
			...
			<div class="right_sec">	
				...
				<!--보낸 쪽지함 start-->	
				<!--경로 /home/allhouse/www/skin/site/basic2/recived_note.php-->					
					<div class="content">
						...
						<div class="">
							...
							<div class="recive_zone_cont">
								<div class="recive_zone_list">
									...
									<div class="recive_list_qa" align="">
										<table class="recive_list_table">
											<colgroup>
											...
											<tr>
												...
												<td class="recive_tit">
													<a href="/?pn=recived_note_contents">
														<strong>전체테스트</strong>
													</a>
												</td>
								...
								</div><!-- //recive_zone_list -->
							</div><!-- //recive_zone_cont -->
