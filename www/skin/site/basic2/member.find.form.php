...
/*
	$PasswordFindType -> 임시비밀번호 발송 수단 => (/program/member.find.form.php에서 지정)
*/
?>
<!-- ◆공통페이지 섹션 -->
<div class="c_section c_member">
	<div class="layout_fix">
		...
		<div class="c_page_tit">
			<div class="title">아이디/비밀번호찾기</div>
						...
						<form class="js_find_id_from" autocomplete="off">
							<div class="form">
								<ul>
									...
									<li><input type="text" name="find_id_tel" class="input_design " placeholder="휴대폰 번호" required/></li>
								</ul>
						...
						<form class="js_find_pw_from" autocomplete="off">
							...
							<?php } else { ?>
								<div class="type js_type">
									<label><input type="radio" name="_type" value="email" checked>이메일로 찾기</label>
									<label><input type="radio" name="_type" value="sms">문자로 찾기</label>
								</div>
							<?php } ?>
							<div class="form">
								<ul>
									<li><input type="text" name="find_pw_id" class="input_design" placeholder="아이디" required /></li>
									<li class="js_email_field"><input type="text" name="find_pw_email" class="input_design " placeholder="이메일 주소" /></li>
									<li class="js_sms_field" style="display:none;"><input type="text" name="find_pw_tel" class="input_design " placeholder="휴대폰 번호" /></li>
								</ul>
								<input type="submit" class="btn_find" value="찾기"/>
							</div>
