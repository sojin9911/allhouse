	...
	<div class="layout_fix">
		...
		<div class="c_board_list board_review">
			...
			<?php } else { ?>
				<table>
					<colgroup>
						<col width="65"/><col width="110"/><col width="40"/><col width="50"/><col width="*"/><col width="100"/><col width="80"/><col width="55"/>
					</colgroup>
					<thead>
						<tr>
							<th scope="col">번호</th>
							...
							<tr class="js_view" data-uid="<?php echo $v['pt_uid']; ?>">
								...
								<td class="tit">
									<div class="title">
										<!-- 클릭시 열림 -->
										<div class="tit_box">
											<a href="#none" class="upper_link js_detail_btn" title="<?php echo addslashes(htmlspecialchars($talk_title)); ?>"><img src="<?php echo $SkinData['skin_url']; ?>/images/c_img/blank.gif" alt=""/></a>
