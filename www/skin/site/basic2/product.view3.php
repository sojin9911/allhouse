            ...
            <ul class="ul">
                ...
                <li class="li view_info">
                    ...
                    <dl class="view-info_dl">
                            ...
                            <dd class=""><?php echo implode(' / ', array_filter(array($pro_maker, $pro_orgin))); //<!-- 슬래시 사이 간격 유지 / 제조사,원산지 중 한개만 있을경우 슬래시 삭제--> ?></dd>
                    </dl>
                    <dl class="view-info_dl">
                    ...
                    <?php if($p_info['p_option_valid_chk']=='Y'  && $isSoldOut == false){ ?>
                        ...
                        ?>
                            <?php
                                ...
                                foreach( $options as $k=>$sr){
                                    ...
                                    $k_idx = $k+1;
                                    $option_select_tmp .= "setTimeout(function(){ option_select_tmp('1' , '{$p_info['p_option_type_chk']}' , '{$sr['po_uid']}' , '{$sr['po_poptionname']}' , '{$p_info['p_code']}','$k_idx'); }, 100);\n";
                            ?>
                            <dl class="view-info_dl">
                                <dt class="view_table-txt"><?=$sr['po_poptionname']?></dt>
                                <dd class="view_table-content">
                                    <div id="span_option<?=$k+1?>" class="view_option_size"></div>
                                </dd>
                            </dl>
                            <?php } ?>
                            <script>
                        ...
                        <div class="view_total">
                            <div class="total_top-box">
                                <div class="tolat_input-btn">
                                    <input type="text" id="total_input">
                                    <span class="total_span-btn">
                                        <button type="button" class="total_btn"><span class="lnr lnr-chevron-up"></span></button>
                                        <button type="button" class="total_btn total_btn-border"><span class="lnr lnr-chevron-down"></span></button>
                                    </span>
                                    <div class="after_price"><strong id="option_select_expricesum_display">0</strong>원</div>
                                </div>
                            </div>
                            <div class="total_bottom-box"><span class="total_tt">총 합계금액</span></div>
...
<script type="text/javascript">
    ...
    function option_select_tmp(idx,pro_depth,pouid,poname,pcode,k_idx) {
        ...
        option_select(idx,pcode,pouid,k_idx);
    }

    function option_select_tmp2(idx,pro_depth,pouid,poname,pcode) {
        option_select_add(pcode);
    }
</script>
<script src="<?php echo $SkinData['skin_url']; ?>/js/option_select.js?<?=date('YmdHi')?>" type="text/javascript"></script>