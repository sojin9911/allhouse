					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
									<div class="input_box">
										<input type="password" name="_pw" class="input_design" placeholder="" autocomplete="new-password" style="width:300px"/>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td >
									<div class="input_box">
										<input type="password" name="_rcpw" class="input_design js_rcpw" placeholder="" autocomplete="new-password" />
