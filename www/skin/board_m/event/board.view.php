	...
	<div class="c_board_view">
		...
		<div class="view_info">
			<div class="txt_box">
				...
				<span class="txt t_writer"><strong><?php echo $boardViewData['writer'];?></strong></span>
				<?php  }?>
				<span class="txt date"><strong><?php echo $boardViewData['rdate'] ?></strong></span>
				<span class="txt t_hit"><strong><?php echo $boardViewData['hit']?></strong></span>
			</div>
		...
		<div class="view_info">
			...
			<div class=" date2"><?php echo $boardViewData['eventSdate']?> ~ <?php echo $boardViewData['eventEdate'] ?></div>
		<?php } ?>
		</div>
