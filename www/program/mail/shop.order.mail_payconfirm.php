			...
			<tbody>
				<tr>
					<td style='text-align:center; border-bottom:1px solid #ddd; padding:3px 0 36px;'>
						...
						<div class='' style='max-width:100%; display:inline-block'><img src='".$app_HTTP_URL."/images/mailing/pay_complete.jpg' alt='주문이 완료 되었습니다.' style='width:100%; border:0 !important'/></div>
					</td>
				</tr>
				<tr>
					<td style='line-height:19px; word-wrap:break-word; word-break:keep-all; font-size:15px; letter-spacing:-1px; color:#666; padding:50px 0 25px; border-bottom:1px solid #ddd;'>
						<!-- 이름 다음에는 br 두개 들어감 -->
						<strong style='color:#333;font-weight:600'>".$arrMailItem['orderName']."님</strong><br/><br/>
						<!-- 쇼핑몰명 -->
						<strong style='color:#333;font-weight:600'>".$siteInfo[s_adshop]."</strong> 주문의 결제가 확인되었습니다.<br/>빠른 시일내에 배송해드리도록 하겠습니다.
					</td>
				</tr>
				<tr>
					<td>
