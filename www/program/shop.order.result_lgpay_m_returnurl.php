...
?>
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="<?php echo $system['url'].OD_PROGRAM_DIR; ?>/shop.order.result_lgpay_m.pro.php">
<?php
...
//	  echo "LGD_RESPCODE:" . iconv("euckr","utf8",$LGD_RESPCODE) . " ,LGD_RESPMSG:" . iconv("euckr","utf8",$LGD_RESPMSG); //인증 실패에 대한 처리 로직 추가
?>
		<script>
		alert("결제가 실패하였습니다. 다시 시도해주시기 바랍니다.");
		top.location.href="/?pn=shop.order.result";
		</script>
<?
  }
?>
