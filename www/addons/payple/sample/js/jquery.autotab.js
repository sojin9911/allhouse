...
(function ($) {
    ...
    var getSettings = function (e) {
        var settings = {
            ...
            filterable: (e.type === 'text' || e.type === 'password' || e.type === 'textarea' || e.type === 'tel'),
            tabOnSelect: false
        };
        ...
        if ($.autotab.selectFilterByClass === true && typeof $(e).data('autotab-format') === 'undefined') {
            var classes = ['all', 'text', 'alpha', 'number', 'numeric', 'alphanumeric', 'hex', 'hexadecimal', 'custom', 'tel'];
    ...
    var getSelection = function (e) {
        ...
        if (e.type === 'text' || e.type === 'password' || e.type === 'textarea' || e.type === 'tel') {
