...
<div class="result">
	...
	//정발행
	$Result = $BaroService_TI->UpdateTaxInvoice(array(
				'CERTKEY'		=> $CERTKEY,
				'CorpNum'		=> $TaxInvoice['InvoicerParty']['CorpNum'],
				'UserID'		=> $TaxInvoice['UserID'],
				'Invoice'		=> $TaxInvoice
				))->UpdateTaxInvoiceResult;
	/*
	//역발행
	$Result = $BaroService_TI->UpdateTaxInvoice(array(
				'CERTKEY'		=> $CERTKEY,
	...
	//위수탁
	$Result = $BaroService_TI->UpdateBrokerTaxInvoice(array(
				'CERTKEY'		=> $CERTKEY,
