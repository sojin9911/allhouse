...
<p>RegistModifyTaxInvoiceEX - 수정세금계산서 등록 (승인 시 자동발행 옵션 추가)</p>
<div class="result">
	<?
	$CERTKEY = '';							//인증키
	...
	//정발행
	$Result = $BaroService_TI->RegistModifyTaxInvoiceEX(array(
				'CERTKEY'				=> $CERTKEY,
	...
	/*
	//위수탁
	$Result = $BaroService_TI->RegistModifyBrokerTaxInvoiceEX(array(
				'CERTKEY'				=> $CERTKEY,
