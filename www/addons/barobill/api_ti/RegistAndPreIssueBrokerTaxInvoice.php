...
<p>RegistAndPreIssueBrokerTaxInvoice - 위수탁 일반(수정)세금계산서 "등록" 과 "발행예정" 을 한번에 처리</p>
<div class="result">
	<?php
	$CERTKEY = '';							//인증키
	...
	$IssueTiming = 1;							//발행시점 : 1-공급자 직접발행, 2-공급받는자 승인시 자동발행
	...
	//정발행
	$Result = $BaroService_TI->RegistAndPreIssueBrokerTaxInvoice(array(
		'CERTKEY'		=> $CERTKEY,
