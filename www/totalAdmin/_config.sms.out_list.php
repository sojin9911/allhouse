<?PHP
	...
	$url = "//mobitalk.gobeyond.co.kr/pages/". ($type == 'charge' ? 'out_charge.form.php' : 'out_mng.list.php') ."?" . $pass_var ;
...
?>
			...
			<div style="width:100%;overflow:auto;" class="wrap_iframe mobitalk_charge"><iframe name="pass_mobitalk" src="<?=$url?>&cross_url=<?php echo urlencode($system['url']); ?>" style="width:100%; min-width:1200px; height:2000px; " scrolling="no"  frameborder=0 class="js_auto_height" ID="wrap_iframe_mobitalk"></iframe></div>
