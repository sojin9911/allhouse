...
.table_list td.td {width:120px; text-align:left;}
...
<div class="data_list">
    ...
    <input type="hidden" name="_search" value="<?php echo enc('e', $s_query); ?>">
        ...
        <table class="table_list">
            <colgroup>
                <col width="45"><col width="70"><col width="90"><col width="135"><col width="60"><col width="*"><col width="90"><col width="90">
            </colgroup>
            <thead>
                <tr>
                ...
                <?php
                 if(sizeof($res) > 0){
                    foreach($res as $k=>$v){
                        ...
                        $sque = "
                            select
                                op.op_uid, op.op_pouid, op.op_pcode, op.op_pname, op.op_option1, op.op_option2, op.op_option3,  op.op_pbrand, op.op_cnt, op.op_instock_cnt, op.op_is_addoption, op.op_cancel, op_sendstatus , op.op_partnerCode,  /* JJC : 입점관리 : 2020-09-17 */
                                p.p_img_list_square
                            from smart_order_product as op
                        ...
                        <tr class="<?php echo ($app_rowspan > 1 ? 'if_more2' : null); ?>" >
                                        ...
                                        ?>
                                                <div class="option">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td_btn">
                                                            <a href="javascript:void(0);" class="c_tag line green h18 t6 js_stock_submit" style="margin:5px 5px;" data-num="<?php echo $v['o_ordernum']; ?>" data-uid="<?php echo $sv['op_uid']; ?>" >입고저장</a>
                                                            <a href="javascript:void(0);" class="c_tag line red h18 t6 js_soldout_submit" style="margin:5px 5px;" data-num="<?php echo $v['o_ordernum']; ?>" data-uid="<?php echo $sv['op_uid']; ?>">품절처리</a>
                                                        </td>
                                                    </tr>
                                                    </table>
                                                </div>
                            ...
                            <td class="<?php echo ($app_rowspan > 1 ? ' this_order' : null); ?>">
                                <div class="lineup-vertical">
                                    <?php echo ($pinfo['status']?$arr_adm_button[$pinfo['status']]:$arr_adm_button['입고대기']); ?>
                                </div>
                            </td>
                            <!-- //주문 상품별 옵션정보:반복 -->
...
<script>
    ...
    $(document).on('click', '.js_stock_submit', function(e) {
        ...
        _url = _url+"?_mode=modify_stock&_ordernum="+_ordernum+"&_uid="+_uid+"&_op_stock_cnt="+_op_stock_cnt;
