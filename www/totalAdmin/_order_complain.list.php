		...
		<table class="table_form">
			...
			<tbody>
				<tr>
					...
					<th>배송상태</th>
					<td>
						<?php echo _InputRadio('pass_sendstatus', array('', '구매발주', '배송중', '배송완료'), $pass_sendstatus, '', array('전체', '구매발주', '배송중', '배송완료'), ''); ?>
					</td>
				</tr>
				<tr>
					<th>주문자 아이디</th>
					...
					<tr data-uid="<?php echo $v['op_uid']; ?>">
						...
						<td>
							<div class="lineup-center">
								...
								<?php } else { ?>
									<?php echo _InputSelect( "op_complain" , $arr_order_complain , $v['op_complain'] , "" , "" , ""); ?>
						...
						<td>
							<div class="lineup-vertical">
								<a href="_order.form.php<?php echo URI_Rebuild('?', array('_mode'=>'modify', '_ordernum'=>$v['op_oordernum'], '_PVSC'=>$_PVSC)); ?>" class="c_btn h22 line" target="_blank">상세보기</a>
								<?php if($v['op_cancel'] === 'N') { ?>
									<a href="_order_complain.pro.php<?php echo URI_Rebuild('?', array('op_complain'=>'reset', 'uid'=>$v['op_uid'], '_PVSC'=>$_PVSC)); ?>" class="c_btn h22 gray line" target="common_frame">요청취소</a>
								<?php } ?>
							</div>
						</td>
					</tr>
