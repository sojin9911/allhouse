...
<div class="popup" style="border:0;">
	...
	<div class="data_list">
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<a href="/upfiles/normal/option<?php echo $pass_common_mode.'depth'; ?>_sample.xls" class="c_btn h27">샘플파일 다운</a>
								<a href="#none" onclick="_common_option_submit();return false;" class="c_btn h27 black">엑셀파일 업로드</a>
								...
								<div class="tip_box">
									...
									<div class="c_tip black">옵션 유형이 컬러인 경우, 색상과 이미지는 엑셀을 통해 일괄 등록할 수 없습니다.</div>
								</div>
							</td>
						</tr>
					</tbody>
		...
		<div class="tip_box">
			...
			<div class="c_tip">공급가, 판매가 항목은 입력 금액을 적용하는 방식으로 적용됩니다.<br>예) 상품 판매가 : <em>10,000원</em> ,판매가 : <em>15,000원</em> 일 경우 옵션 적용 시 <em>15,000원</em>이 적용됩니다.</div>
		</div>
