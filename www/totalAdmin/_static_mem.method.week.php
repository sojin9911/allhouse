	...
	<tbody>
		...
		<tr>
			<td colspan="2" >
				...
				<? // ------- 회원 가입형태 분석 Summary ------- ?>
				<div class="group_title"><strong><?=DATE("Y년 m월 d일" , strtotime($pass_date) )?> ~ <?=DATE("Y년 m월 d일" , strtotime($pass_edate) )?> 요일별 회원 가입형태 분석 요약</strong></div>
...
<?php
	...
	foreach( $mem_date as $mem_datek => $mem_datev ){
		...
		$arr_table_data[] = array(
				...
				'rdate' => week_name( $mem_datev['rdate'] , '요일'),
...
<script type="text/javascript" class="code-js">
    ...
    var grid = new tui.Grid({
        ...
        columnModelList: [
            {"title" : "<b>요일</b>", "columnName" : "rdate", "align" : "center", "width" : 60 },
