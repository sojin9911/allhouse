...
?>
	...
	<!-- // KAY :: 일괄업로드 :: 2021-07-02 -- 일괄업로드 엑셀 오픈코드 upload.pop.php로 이동-->
	<!-- ● 단락타이틀 -->
	<div class="group_title">
		...
		<a href="#none" class="c_btn h46 red line js_open_excel_box">일괄업로드</a>
		</div>
	</div>
		...
		<input type="hidden" name="_search" value="<?php echo enc('e', $s_query); ?>">
			...
			<div class="list_ctrl">
				<div class="left_box">
					...
					<a href="#none" onclick="selectSortModify(); return false;" class="c_btn h27 gray">선택 순위수정</a>
				</div>
				<div class="right_box">
			...
			<table class="table_list">
				<colgroup>
					<col width="40"><col width="70"><col width="120"><col width="70"><col width="140"><col width="90"><col width="*"><col width="100"><col width="80"><col width="90"><col width="160">
				</colgroup>
				<thead>
					<tr>
							...
							<tr>
								...
								<td>
									<div class="lineup-center" style="margin-bottom:5px;">
										<input type="text" name="sort_group[<?php echo $v['p_code']; ?>]" value="<?php echo $v['p_sort_group']?>" class="design number_style sort_group_<?php echo $v['p_code']; ?>" placeholder="" style="width:45px;margin-right:0;">
										<a href="#none" onclick="sort_group('<?php echo $v['p_code']; ?>')" class="c_btn h27 " style="width:45px;">수정</a>
									</div>
								...
								<td class="img80">
									<div class="thumb">
										...
										<!-- 옵션등록에러일때만 나옴 --><div class="error"><span>옵션등록<br/>오류상품</span></div>
										<?php } ?>
								...
								<td class="t_left t_black">
									<?php
										...
										// JJC : 입점관리 : 2020-09-17
										echo ($SubAdminMode === true && $AdminPath == 'totalAdmin' && $v['p_cpid'] ? "<span style='font-weight:normal; color:#999;'>입점업체 : ".$arr_customer2[$v['p_cpid']] . "</span><br>" : "") ;
								...
								<td>
									...
									<div class="lineup-vertical">
										...
										<a href="#none" onclick="edit_img_pop('<?php echo $v['p_code'] ?>')" class="c_btn h22 green">이미지 관리</a>
									</div>
								</td>
							</tr>
					<?php
