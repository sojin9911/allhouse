...
<div class="data_list">
	...
	<div class="total_price">
		<div>
			<ul>
				<li>수량 : <strong><?php echo number_format(array_sum($arr_sum['product_cnt'])); ?></strong><em>개</em></li>
				<li>금액 : <strong><?php echo number_format(array_sum($arr_sum['product_price'])); ?></strong><em>원</em></li>
				<li>정산금액 : <strong><?php echo number_format(array_sum($arr_sum['comPrice'])); ?></strong><em>원</em></li>
				<li>배송비 : <strong><?php echo number_format(array_sum($arr_sum['delivery_price'])); ?></strong><em>원</em></li>
			</ul>
		</div>
	</div>
</div>
		...
		<tbody>
			...
			<tr>
				...
				<td class="only_text bold">
					<?php echo number_format(array_sum($arr_sum['product_price'])); ?>원
				</td>
				<th>배송비</th>
				<td class="only_text bold">
					<?php echo number_format(array_sum($arr_sum['delivery_price'])); ?>원
				</td>
			</tr>
			<tr>
				<th>할인액</th>
				<td class="only_text bold">
					<?php echo number_format(array_sum($arr_sum['product_usepoint'])); ?>원
				</td>
				<th>상품수</th>
				<td class="only_text bold">
					<?php echo number_format(array_sum($arr_sum['product_cnt'])); ?>개
				</td>
			</tr>
			<tr>
				<th>업체정산액</th>
				<td class="only_text bold">
					<?php echo number_format(array_sum($arr_sum['comPrice'])); ?>원
				</td>
				<th>수수료</th>
				<td class="only_text bold">
					<?php echo number_format(array_sum($arr_sum['product_price']) + array_sum($arr_sum['delivery_price']) - array_sum($arr_sum['comPrice']) - array_sum($arr_sum['product_usepoint'])); ?>원
				</td>
			</tr>
		</tbody>
	</table>
