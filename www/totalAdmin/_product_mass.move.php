				...
				<tbody>
					<tr>
						...
						<td>
							...
							<a href="#none" onclick="selectCategoryCopy();" class="c_btn h27 gray">선택 상품 복사 + 카테고리 추가</a>
							...
							<div class="tip_box">
								<?=_DescStr("반드시 원하는 카테고리를 먼저 선택한 다음 추가/삭제/복사를 실행하시기 바랍니다.")?>
								<?=_DescStr("<strong>선택 상품 복사 + 카테고리 추가의 경우 갯수에 따라 시간이 많이 소요</strong>될 수 있습니다. 되도록 <strong>5개 이하 단위로 실행</strong>해 주시기 바랍니다.")?>
							</div>
