...
<form class="form_list" method="post" target="">
	...
	<div class="data_list">
		...
		<div class="list_ctrl">
			<div class="left_box">
				<a href="#none" onclick="settlement_status_ready(); return false;" class="c_btn h27 gray">정산대기 전환</a>
			</div>
			<div class="right_box">
				...
				<tbody>
					<?php foreach($res as $k=>$v) { ?>
						<tr>
							...
							<td class="t_left">
								<?php echo showCompanyInfo($v['s_partnerCode']); ?>
							</td>
							<td>
