...
for($i=1 ; $i<=12 ; $i++){
	...
	// ------------------------ 기간 내 상태 분석 ------------------------
	$arr_date_num['auth'][$i] = $arr_data['auth'][$Select_Year . sprintf("%02d" , $i)] * 1;// 선택월 승인 회원수
	...
	<tbody>
		...
		<tr>
			<td colspan="2" >
				...
				<? // ------- 회원 상태 분석 Summary ------- ?>
				<div class="group_title"><strong><?php echo $Select_Year; ?>년 회원 상태 분석 요약</strong></div>
...
<script>
	...
	var chartData = {
		...
		{
			type: 'bar',
			label: '<?php echo $Select_Year; ?>년 승인 회원수',
