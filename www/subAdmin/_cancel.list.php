...
// 검색 체크
$s_query = " and op.op_partnerCode = '{$com_id}' and o.npay_order = 'N' ";
...
<!-- ● 데이터 리스트 -->
<div class="data_list">
	<form action="_cancel.pro.php" method="post" class="form_list"<?php echo ($c?null:' target="common_frame"'); ?>>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<div class="lineup-vertical">
									<a href="_order.form.php<?php echo URI_Rebuild('?', array('view'=>'cancel', '_mode'=>'modify', '_ordernum'=>$v['op_oordernum'], '_PVSC'=>$_PVSC)); ?>" class="c_btn h22 line">상세보기</a>
								</div>
							</td>
						</tr>
					<?php } ?>
