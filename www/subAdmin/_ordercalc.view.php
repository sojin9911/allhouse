				...
				<tr>
					<td colspan="2">
						<div class="tip_box">
							...
							<?php echo _DescStr('결제확인 된 주문에 대한 현황이며 배송비는 총결제비에 포함되지 않으므로 참고하시기 바랍니다.'); ?>
						</div>
					</td>
				</tr>
			</tbody>
...
<script type="text/javascript">
	function search_excel_send() {
		common_frame.location.href = '_ordercalc.excel.php?pass_sdate=<?php echo $pass_sdate; ?>&pass_edate=<?php echo $pass_edate; ?>';
	}
</script>
