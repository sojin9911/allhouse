...
<head>
	<title><?php echo $siteInfo['s_glbtlt']; ?> :: 하이센스 V3.0 입점 관리자</title>
	...
	<link href="<?php echo OD_ADMIN_URL; ?>/css/subAdmin.css" rel="stylesheet" type="text/css" />
