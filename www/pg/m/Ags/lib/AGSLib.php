 ...
 * Copyright 2010-2010 AEGISHYOSUNG.Co.,Ltd. All rights reserved.	
 *
 */
...
class agspay40
{
	...
	*/
	...
	function MakeNetCancID()
	{
		...
		//TID는 최소 31자리 ,최대 50자리를 넘지 않는다.
		$this->RESULT["NetCancID"] = "AEGIS_".$TidTp . $this->REQUEST["StoreId"] . "_" . $datestr . rand(100,999);
		if( (!strlen( $this->RESULT["NetCancID"] ) >= 31 && strlen( $this->RESULT["NetCancID"] ) <= 50) )
		{
