<?
    ...
    $g_conf_home_dir  = PG_M_DIR."/kcp";    // 절대경로 입력
...
if("T0000" == $siteInfo[s_pg_code]) $g_conf_gw_url = "testpaygw.kcp.co.kr";
...
if("T0000" == $siteInfo[s_pg_code]) $g_wsdl = $g_conf_home_dir."/common/KCPPaymentService.wsdl";
else $g_wsdl =  OD_PROGRAM_ROOT."/shop.order.result_kcp.wsdl";

	

/*
echo "<br>pub_pgtest1->".$pub_pgtest;
echo "<br>g_conf_gw_url->".$g_conf_gw_url;
echo "<br>g_conf_site_cd->".$g_conf_site_cd;
echo "<br>g_conf_site_key->".$g_conf_site_key;
echo "<br>g_conf_site_name->".$g_conf_site_name;
echo "<br>g_wsdl->".$g_wsdl;
*/
