...
?>				
                <table width="527" border="0" cellspacing="0" cellpadding="0" class="margin_top_20">
                    ...
                    <tr>
                        ...
                        <td class="sub_input1"><input type="text" name="rcvr_name" class="frminput" value="홍길순"/></td>
                    </tr>
                    <!-- 수취인 연락처1(rcvr_tel1) -->
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="sub_input1"><input type="text" name="rcvr_add2" class="frminput" value="170-5 우림E-biz센터"/></td>
                    </tr>
                </table>
<?
    /* = -------------------------------------------------------------------------- = */
