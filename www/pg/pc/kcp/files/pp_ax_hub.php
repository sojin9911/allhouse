    ...
    if ( $tran_cd != "" )
    {
        $c_PayPlus->mf_do_tx( $trace_no, $g_conf_home_dir, $g_conf_site_cd, "", $tran_cd, "",
			...
			$res_msg = $c_PayPlus->m_res_msg; // 결과 메시지
				...
				/*
				echo("trace_no : ".$trace_no."<BR>");
				echo("g_conf_home_dir : ".$g_conf_home_dir."<BR>");
				echo("g_conf_site_cd : ".$g_conf_site_cd."<BR>");
				echo("tran_cd : ".$tran_cd."<BR>");
				echo("g_conf_gw_url : ".$g_conf_gw_url."<BR>");
				echo("g_conf_gw_port : ".$g_conf_gw_port."<BR>");
				echo("ordr_idxx : ".$ordr_idxx."<BR>");
				echo("cust_ip : ".$cust_ip."<BR>");
				echo("g_conf_key_dir : ".$g_conf_key_dir."<BR>");
				echo("g_conf_log_dir : ".$g_conf_log_dir."<BR>");
