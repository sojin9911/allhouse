...
*
* Copyright 2006-2009 AEGISHYOSUNG.Co.,Ltd. All rights reserved.
*
**********************************************************************************************/ 
...
$rResMsg = trim(iconv("EUC-KR","UTF-8", $_POST["rResMsg"]) );		//실패사유
...
<!--
var openwin = window.open("testAGS_progress.html","popup","width=300,height=160");
openwin.close();
-->
</script>
</head>
...
<?	}	?>	
			...
			<tr>
				<td class=clsleft>Copyright 2006-2009 AEGISHYOSUNG.Co.,Ltd. All rights reserved.</td>
			</tr>
		</table>
		</td>
	</tr>
