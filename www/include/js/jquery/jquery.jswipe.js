...
var defaults={threshold:{x:30,y:0},swipeLeft:function(){/*alert('swiped left')*/change_left();},swipeRight:function(){/*alert('swiped right')*/change_right();}};
var options=$.extend(defaults,options);if(!this)return false;return this.each(function(){var me=$(this)
